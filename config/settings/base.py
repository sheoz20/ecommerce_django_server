...
DATABASES = {
    'default': env.db(
        'DATABASE_URL',
        default='postgres://postgres:postgres@localhost:5432/ecommerce_db'
    )
}
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'A scalable e-commerce backend API built with Django REST Framework',
    'VERSION': '1.0.0',
...
CELERY_BROKER_URL = env('REDIS_URL', default=None) or 'memory://'
CELERY_RESULT_BACKEND = env('REDIS_URL', default=None) or 'cache'
